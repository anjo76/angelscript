...
int asCContext::GetStateRegisters(asUINT stackLevel, asIScriptFunction **_callingSystemFunction, asIScriptFunction **_initialFunction, asDWORD *_originalStackPointer, asDWORD *_argumentSize, asQWORD *_valueRegister, void **_objectRegister, asITypeInfo **_objectRegisterType)
{
	...
	{
		const asPWORD *tmp = &m_callStack[m_callStack.GetLength() - CALLSTACK_FRAME_SIZE * stackLevel];
...
int asCContext::GetCallStateRegisters(asUINT stackLevel, asDWORD *_stackFramePointer, asIScriptFunction **_currentFunction, asDWORD *_programPointer, asDWORD *_stackPointer, asDWORD *_stackIndex)
{
	...
	{
		const asPWORD *s = &m_callStack[m_callStack.GetLength() - CALLSTACK_FRAME_SIZE * stackLevel];
...
void asCContext::ExecuteNext()
{
	...
	for( ;; )
	{
		...
		BEGIN()
		{
			...
			INSTRUCTION(asBC_PopPtr) : // Pop a pointer from the stack
			                           l_sp += AS_PTR_SIZE;
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_PshGPtr) : // Replaces PGA + RDSPtr
			                            l_sp -= AS_PTR_SIZE;
			...
			*l_sp  = *(asDWORD *)asBC_PTRARG(l_bc);
			...
			INSTRUCTION(asBC_LdGRdR4) : *(void **)&m_regs.valueRegister  = (void *)asBC_PTRARG(l_bc);
			*(l_fp - asBC_SWORDARG0(l_bc))                               = **(asDWORD **)&m_regs.valueRegister;
			...
			INSTRUCTION(asBC_JMP) : l_bc += 2 + asBC_INTARG(l_bc);
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_NEGi) : *(l_fp - asBC_SWORDARG0(l_bc)) = asDWORD(-int(*(l_fp - asBC_SWORDARG0(l_bc))));
			l_bc++;
			NEXT_INSTRUCTION();

			// Negate the float value in the variable
			INSTRUCTION(asBC_NEGf) : *(float *)(l_fp - asBC_SWORDARG0(l_bc)) = -*(float *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			// Negate the double value in the variable
			INSTRUCTION(asBC_NEGd) : *(double *)(l_fp - asBC_SWORDARG0(l_bc)) = -*(double *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_INCi16) : (**(short **)&m_regs.valueRegister)++;
			l_bc++;
			NEXT_INSTRUCTION();

			// Increment the byte value pointed to by the register
			INSTRUCTION(asBC_INCi8) : (**(char **)&m_regs.valueRegister)++;
			l_bc++;
			NEXT_INSTRUCTION();

			// Decrement the short value pointed to by the register
			INSTRUCTION(asBC_DECi16) : (**(short **)&m_regs.valueRegister)--;
			l_bc++;
			NEXT_INSTRUCTION();

			// Decrement the byte value pointed to by the register
			INSTRUCTION(asBC_DECi8) : (**(char **)&m_regs.valueRegister)--;
			l_bc++;
			NEXT_INSTRUCTION();

			// Increment the integer value pointed to by the register
			INSTRUCTION(asBC_INCi) : ++(**(int **)&m_regs.valueRegister);
			l_bc++;
			NEXT_INSTRUCTION();

			// Decrement the integer value pointed to by the register
			INSTRUCTION(asBC_DECi) : --(**(int **)&m_regs.valueRegister);
			l_bc++;
			NEXT_INSTRUCTION();

			// Increment the float value pointed to by the register
			INSTRUCTION(asBC_INCf) : ++(**(float **)&m_regs.valueRegister);
			l_bc++;
			NEXT_INSTRUCTION();

			// Decrement the float value pointed to by the register
			INSTRUCTION(asBC_DECf) : --(**(float **)&m_regs.valueRegister);
			l_bc++;
			NEXT_INSTRUCTION();

			// Increment the double value pointed to by the register
			INSTRUCTION(asBC_INCd) : ++(**(double **)&m_regs.valueRegister);
			l_bc++;
			NEXT_INSTRUCTION();

			// Decrement the double value pointed to by the register
			INSTRUCTION(asBC_DECd) : --(**(double **)&m_regs.valueRegister);
			l_bc++;
			NEXT_INSTRUCTION();

			// Increment the local integer variable
			INSTRUCTION(asBC_IncVi) : (*(int *)(l_fp - asBC_SWORDARG0(l_bc)))++;
			l_bc++;
			NEXT_INSTRUCTION();

			// Decrement the local integer variable
			INSTRUCTION(asBC_DecVi) : (*(int *)(l_fp - asBC_SWORDARG0(l_bc)))--;
			l_bc++;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_BNOT) : *(l_fp - asBC_SWORDARG0(l_bc)) = ~*(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			// Do a bitwise and of two variables and store the result in a third variable
			INSTRUCTION(asBC_BAND) : *(l_fp - asBC_SWORDARG0(l_bc))  = *(l_fp - asBC_SWORDARG1(l_bc)) & *(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                    += 2;
			NEXT_INSTRUCTION();

			// Do a bitwise or of two variables and store the result in a third variable
			INSTRUCTION(asBC_BOR) : *(l_fp - asBC_SWORDARG0(l_bc))  = *(l_fp - asBC_SWORDARG1(l_bc)) | *(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                   += 2;
			NEXT_INSTRUCTION();

			// Do a bitwise xor of two variables and store the result in a third variable
			INSTRUCTION(asBC_BXOR) : *(l_fp - asBC_SWORDARG0(l_bc))  = *(l_fp - asBC_SWORDARG1(l_bc)) ^ *(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                    += 2;
			NEXT_INSTRUCTION();

			// Do a logical shift left of two variables and store the result in a third variable
			INSTRUCTION(asBC_BSLL) : *(l_fp - asBC_SWORDARG0(l_bc))  = *(l_fp - asBC_SWORDARG1(l_bc)) << *(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                    += 2;
			NEXT_INSTRUCTION();

			// Do a logical shift right of two variables and store the result in a third variable
			INSTRUCTION(asBC_BSRL) : *(l_fp - asBC_SWORDARG0(l_bc))  = *(l_fp - asBC_SWORDARG1(l_bc)) >> *(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                    += 2;
			NEXT_INSTRUCTION();

			// Do an arithmetic shift right of two variables and store the result in a third variable
			INSTRUCTION(asBC_BSRA) : *(l_fp - asBC_SWORDARG0(l_bc))  = int(*(l_fp - asBC_SWORDARG1(l_bc))) >> *(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                    += 2;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_PshC8) : l_sp -= 2;
			*(asQWORD *)l_sp                = asBC_QWORDARG(l_bc);
			l_bc                           += 3;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_PshVPtr) : l_sp -= AS_PTR_SIZE;
			*(asPWORD *)l_sp                  = *(asPWORD *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_JMPP) : l_bc += 1 + (*(int *)(l_fp - asBC_SWORDARG0(l_bc))) * 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_PopRPtr) : *(asPWORD *)&m_regs.valueRegister  = *(asPWORD *)l_sp;
			l_sp                                                          += AS_PTR_SIZE;
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_PshRPtr) : l_sp -= AS_PTR_SIZE;
			*(asPWORD *)l_sp                  = *(asPWORD *)&m_regs.valueRegister;
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_STR) : // TODO: NEWSTRING: Deprecate this instruction
			                        asASSERT(false);
			l_bc++;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_SUSPEND) : if( m_regs.doProcessSuspend )
			{
				if( m_lineCallback )
				{
					m_regs.programPointer    = l_bc;
			...
			INSTRUCTION(asBC_STOREOBJ) : // Move the object pointer from the object register to the object variable
			...
			INSTRUCTION(asBC_PshNull) : // Push a null pointer on the stack
			                            l_sp -= AS_PTR_SIZE;
			*(asPWORD *)l_sp                  = 0;
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_ClrVPtr) : // TODO: runtime optimize: Is this instruction really necessary?
			...
			INSTRUCTION(asBC_OBJTYPE) : // Push the object type on the stack
			                            l_sp -= AS_PTR_SIZE;
			*(asPWORD *)l_sp                  = asBC_PTRARG(l_bc);
			l_bc                             += 1 + AS_PTR_SIZE;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_TYPEID) : // Equivalent to PshC4, but kept as separate instruction for bytecode serialization
			                           --l_sp;
			*l_sp  = asBC_DWORDARG(l_bc);
			l_bc  += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_SetV4) : *(l_fp - asBC_SWORDARG0(l_bc))  = asBC_DWORDARG(l_bc);
			l_bc                                                     += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_SetV8) : *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc))  = asBC_QWORDARG(l_bc);
			l_bc                                                                += 3;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_CpyVtoV4) : *(l_fp - asBC_SWORDARG0(l_bc))  = *(l_fp - asBC_SWORDARG1(l_bc));
			l_bc                                                        += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_CpyVtoV8) : *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc))  = *(asQWORD *)(l_fp - asBC_SWORDARG1(l_bc));
			l_bc                                                                   += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_CpyVtoR4) : *(asDWORD *)&m_regs.valueRegister = *(asDWORD *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_CpyVtoR8) : *(asQWORD *)&m_regs.valueRegister = *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_CpyVtoG4) : *(asDWORD *)asBC_PTRARG(l_bc)  = *(asDWORD *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc                                                       += 1 + AS_PTR_SIZE;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_CpyRtoV4) : *(asDWORD *)(l_fp - asBC_SWORDARG0(l_bc)) = *(asDWORD *)&m_regs.valueRegister;
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_CpyRtoV8) : *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc)) = m_regs.valueRegister;
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_CpyGtoV4) : *(asDWORD *)(l_fp - asBC_SWORDARG0(l_bc))  = *(asDWORD *)asBC_PTRARG(l_bc);
			l_bc                                                                   += 1 + AS_PTR_SIZE;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_WRTV1) : // The pointer in the register points to a byte, and *(l_fp - offset) too
			                          **(asBYTE **)&m_regs.valueRegister = *(asBYTE *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_WRTV2) : // The pointer in the register points to a word, and *(l_fp - offset) too
			                          **(asWORD **)&m_regs.valueRegister = *(asWORD *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_WRTV4) : **(asDWORD **)&m_regs.valueRegister = *(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_WRTV8) : **(asQWORD **)&m_regs.valueRegister = *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_RDR4) : *(asDWORD *)(l_fp - asBC_SWORDARG0(l_bc)) = **(asDWORD **)&m_regs.valueRegister;
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_RDR8) : *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc)) = **(asQWORD **)&m_regs.valueRegister;
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_LDG) : *(asPWORD *)&m_regs.valueRegister  = asBC_PTRARG(l_bc);
			l_bc                                                      += 1 + AS_PTR_SIZE;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_LDV) : *(asDWORD **)&m_regs.valueRegister = (l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_PGA) : l_sp -= AS_PTR_SIZE;
			*(asPWORD *)l_sp              = asBC_PTRARG(l_bc);
			l_bc                         += 1 + AS_PTR_SIZE;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_VAR) : l_sp -= AS_PTR_SIZE;
			*(asPWORD *)l_sp              = (asPWORD)asBC_SWORDARG0(l_bc);
			...
			//----------------------------
			// Type conversions
			INSTRUCTION(asBC_iTOf) : *(float *)(l_fp - asBC_SWORDARG0(l_bc)) = float(*(int *)(l_fp - asBC_SWORDARG0(l_bc)));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_fTOi) : *(l_fp - asBC_SWORDARG0(l_bc)) = int(*(float *)(l_fp - asBC_SWORDARG0(l_bc)));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_uTOf) : *(float *)(l_fp - asBC_SWORDARG0(l_bc)) = float(*(l_fp - asBC_SWORDARG0(l_bc)));
			l_bc++;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_sbTOi) : // *(l_fp - offset) points to a char, and will point to an int afterwards
			                          *(l_fp - asBC_SWORDARG0(l_bc)) = *(signed char *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_swTOi) : // *(l_fp - offset) points to a short, and will point to an int afterwards
			                          *(l_fp - asBC_SWORDARG0(l_bc)) = *(short *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_ubTOi) : // (l_fp - offset) points to a byte, and will point to an int afterwards
			                          *(l_fp - asBC_SWORDARG0(l_bc)) = *(asBYTE *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_uwTOi) : // *(l_fp - offset) points to a word, and will point to an int afterwards
			                          *(l_fp - asBC_SWORDARG0(l_bc)) = *(asWORD *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_dTOi) : *(l_fp - asBC_SWORDARG0(l_bc))  = int(*(double *)(l_fp - asBC_SWORDARG1(l_bc)));
			l_bc                                                    += 2;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_dTOf) : *(float *)(l_fp - asBC_SWORDARG0(l_bc))  = float(*(double *)(l_fp - asBC_SWORDARG1(l_bc)));
			l_bc                                                             += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_iTOd) : *(double *)(l_fp - asBC_SWORDARG0(l_bc))  = double(*(int *)(l_fp - asBC_SWORDARG1(l_bc)));
			l_bc                                                              += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_uTOd) : *(double *)(l_fp - asBC_SWORDARG0(l_bc))  = double(*(asUINT *)(l_fp - asBC_SWORDARG1(l_bc)));
			l_bc                                                              += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_fTOd) : *(double *)(l_fp - asBC_SWORDARG0(l_bc))  = double(*(float *)(l_fp - asBC_SWORDARG1(l_bc)));
			l_bc                                                              += 2;
			NEXT_INSTRUCTION();

			//------------------------------
			// Math operations
			INSTRUCTION(asBC_ADDi) : *(int *)(l_fp - asBC_SWORDARG0(l_bc))  = *(int *)(l_fp - asBC_SWORDARG1(l_bc)) + *(int *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                           += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_SUBi) : *(int *)(l_fp - asBC_SWORDARG0(l_bc))  = *(int *)(l_fp - asBC_SWORDARG1(l_bc)) - *(int *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                           += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_MULi) : *(int *)(l_fp - asBC_SWORDARG0(l_bc))  = *(int *)(l_fp - asBC_SWORDARG1(l_bc)) * *(int *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                           += 2;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_ADDf) : *(float *)(l_fp - asBC_SWORDARG0(l_bc))  = *(float *)(l_fp - asBC_SWORDARG1(l_bc)) + *(float *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                             += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_SUBf) : *(float *)(l_fp - asBC_SWORDARG0(l_bc))  = *(float *)(l_fp - asBC_SWORDARG1(l_bc)) - *(float *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                             += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_MULf) : *(float *)(l_fp - asBC_SWORDARG0(l_bc))  = *(float *)(l_fp - asBC_SWORDARG1(l_bc)) * *(float *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                             += 2;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_ADDd) : *(double *)(l_fp - asBC_SWORDARG0(l_bc))  = *(double *)(l_fp - asBC_SWORDARG1(l_bc)) + *(double *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                              += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_SUBd) : *(double *)(l_fp - asBC_SWORDARG0(l_bc))  = *(double *)(l_fp - asBC_SWORDARG1(l_bc)) - *(double *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                              += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_MULd) : *(double *)(l_fp - asBC_SWORDARG0(l_bc))  = *(double *)(l_fp - asBC_SWORDARG1(l_bc)) * *(double *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                              += 2;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_ADDIi) : *(int *)(l_fp - asBC_SWORDARG0(l_bc))  = *(int *)(l_fp - asBC_SWORDARG1(l_bc)) + asBC_INTARG(l_bc + 1);
			l_bc                                                            += 3;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_SUBIi) : *(int *)(l_fp - asBC_SWORDARG0(l_bc))  = *(int *)(l_fp - asBC_SWORDARG1(l_bc)) - asBC_INTARG(l_bc + 1);
			l_bc                                                            += 3;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_MULIi) : *(int *)(l_fp - asBC_SWORDARG0(l_bc))  = *(int *)(l_fp - asBC_SWORDARG1(l_bc)) * asBC_INTARG(l_bc + 1);
			l_bc                                                            += 3;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_ADDIf) : *(float *)(l_fp - asBC_SWORDARG0(l_bc))  = *(float *)(l_fp - asBC_SWORDARG1(l_bc)) + asBC_FLOATARG(l_bc + 1);
			l_bc                                                              += 3;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_SUBIf) : *(float *)(l_fp - asBC_SWORDARG0(l_bc))  = *(float *)(l_fp - asBC_SWORDARG1(l_bc)) - asBC_FLOATARG(l_bc + 1);
			l_bc                                                              += 3;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_MULIf) : *(float *)(l_fp - asBC_SWORDARG0(l_bc))  = *(float *)(l_fp - asBC_SWORDARG1(l_bc)) * asBC_FLOATARG(l_bc + 1);
			l_bc                                                              += 3;
			NEXT_INSTRUCTION();

			//-----------------------------------
			INSTRUCTION(asBC_SetG4) : *(asDWORD *)asBC_PTRARG(l_bc)  = asBC_DWORDARG(l_bc + AS_PTR_SIZE);
			l_bc                                                    += 2 + AS_PTR_SIZE;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_SetV1) : // TODO: This is exactly the same as SetV4. This is a left over from the time
			...
			INSTRUCTION(asBC_SetV2) : // TODO: This is exactly the same as SetV4. This is a left over from the time
			                          //       when the bytecode instructions were more tightly packed. It can now
			                          //       be removed. When removing it, make sure the value is correctly converted
			                          //       on big-endian CPUs.
			...
			INSTRUCTION(asBC_i64TOi) : *(l_fp - asBC_SWORDARG0(l_bc))  = int(*(asINT64 *)(l_fp - asBC_SWORDARG1(l_bc)));
			l_bc                                                      += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_uTOi64) : *(asINT64 *)(l_fp - asBC_SWORDARG0(l_bc))  = asINT64(*(asUINT *)(l_fp - asBC_SWORDARG1(l_bc)));
			l_bc                                                                 += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_iTOi64) : *(asINT64 *)(l_fp - asBC_SWORDARG0(l_bc))  = asINT64(*(int *)(l_fp - asBC_SWORDARG1(l_bc)));
			l_bc                                                                 += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_fTOi64) : *(asINT64 *)(l_fp - asBC_SWORDARG0(l_bc))  = asINT64(*(float *)(l_fp - asBC_SWORDARG1(l_bc)));
			l_bc                                                                 += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_dTOi64) : *(asINT64 *)(l_fp - asBC_SWORDARG0(l_bc)) = asINT64(*(double *)(l_fp - asBC_SWORDARG0(l_bc)));
			l_bc++;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_i64TOf) : *(float *)(l_fp - asBC_SWORDARG0(l_bc))  = float(*(asINT64 *)(l_fp - asBC_SWORDARG1(l_bc)));
			l_bc                                                               += 2;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_i64TOd) : *(double *)(l_fp - asBC_SWORDARG0(l_bc)) = double(*(asINT64 *)(l_fp - asBC_SWORDARG0(l_bc)));
			l_bc++;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_NEGi64) : *(asINT64 *)(l_fp - asBC_SWORDARG0(l_bc)) = -*(asINT64 *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_INCi64) : ++(**(asQWORD **)&m_regs.valueRegister);
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_DECi64) : --(**(asQWORD **)&m_regs.valueRegister);
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_BNOT64) : *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc)) = ~*(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc));
			l_bc++;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_ADDi64) : *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc))  = *(asQWORD *)(l_fp - asBC_SWORDARG1(l_bc)) + *(asQWORD *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                                 += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_SUBi64) : *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc))  = *(asQWORD *)(l_fp - asBC_SWORDARG1(l_bc)) - *(asQWORD *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                                 += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_MULi64) : *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc))  = *(asQWORD *)(l_fp - asBC_SWORDARG1(l_bc)) * *(asQWORD *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                                 += 2;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_BAND64) : *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc))  = *(asQWORD *)(l_fp - asBC_SWORDARG1(l_bc)) & *(asQWORD *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                                 += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_BOR64) : *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc))  = *(asQWORD *)(l_fp - asBC_SWORDARG1(l_bc)) | *(asQWORD *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                                += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_BXOR64) : *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc))  = *(asQWORD *)(l_fp - asBC_SWORDARG1(l_bc)) ^ *(asQWORD *)(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                                 += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_BSLL64) : *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc))  = *(asQWORD *)(l_fp - asBC_SWORDARG1(l_bc)) << *(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                                 += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_BSRL64) : *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc))  = *(asQWORD *)(l_fp - asBC_SWORDARG1(l_bc)) >> *(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                                 += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_BSRA64) : *(asINT64 *)(l_fp - asBC_SWORDARG0(l_bc))  = *(asINT64 *)(l_fp - asBC_SWORDARG1(l_bc)) >> *(l_fp - asBC_SWORDARG2(l_bc));
			l_bc                                                                 += 2;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(asBC_FuncPtr) : // Push the function pointer on the stack. The pointer is in the argument
			                            l_sp -= AS_PTR_SIZE;
			*(asPWORD *)l_sp                  = asBC_PTRARG(l_bc);
			l_bc                             += 1 + AS_PTR_SIZE;
			NEXT_INSTRUCTION();
			...
			*(asQWORD *)l_sp                = *(asQWORD *)(l_fp - asBC_SWORDARG0(l_bc));
			...
			INSTRUCTION(asBC_JLowZ) : if( *(asBYTE *)&m_regs.valueRegister == 0 )
			                              l_bc += asBC_INTARG(l_bc) + 2;
			else l_bc                          += 2;
			NEXT_INSTRUCTION();

			INSTRUCTION(asBC_JLowNZ) : if( *(asBYTE *)&m_regs.valueRegister != 0 )
			                               l_bc += asBC_INTARG(l_bc) + 2;
			else l_bc                           += 2;
			NEXT_INSTRUCTION();
			...
			INSTRUCTION(201) : l_bc = (asDWORD *)201;
			goto case_FAULT;
			INSTRUCTION(202) : l_bc = (asDWORD *)202;
			goto case_FAULT;
			INSTRUCTION(203) : l_bc = (asDWORD *)203;
			goto case_FAULT;
			INSTRUCTION(204) : l_bc = (asDWORD *)204;
			goto case_FAULT;
			INSTRUCTION(205) : l_bc = (asDWORD *)205;
			goto case_FAULT;
			INSTRUCTION(206) : l_bc = (asDWORD *)206;
			goto case_FAULT;
			INSTRUCTION(207) : l_bc = (asDWORD *)207;
			goto case_FAULT;
			INSTRUCTION(208) : l_bc = (asDWORD *)208;
			goto case_FAULT;
			INSTRUCTION(209) : l_bc = (asDWORD *)209;
			goto case_FAULT;
			INSTRUCTION(210) : l_bc = (asDWORD *)210;
			goto case_FAULT;
			INSTRUCTION(211) : l_bc = (asDWORD *)211;
			goto case_FAULT;
			INSTRUCTION(212) : l_bc = (asDWORD *)212;
			goto case_FAULT;
			INSTRUCTION(213) : l_bc = (asDWORD *)213;
			goto case_FAULT;
			INSTRUCTION(214) : l_bc = (asDWORD *)214;
			goto case_FAULT;
			INSTRUCTION(215) : l_bc = (asDWORD *)215;
			goto case_FAULT;
			INSTRUCTION(216) : l_bc = (asDWORD *)216;
			goto case_FAULT;
			INSTRUCTION(217) : l_bc = (asDWORD *)217;
			goto case_FAULT;
			INSTRUCTION(218) : l_bc = (asDWORD *)218;
			goto case_FAULT;
			INSTRUCTION(219) : l_bc = (asDWORD *)219;
			goto case_FAULT;
			INSTRUCTION(220) : l_bc = (asDWORD *)220;
			goto case_FAULT;
			INSTRUCTION(221) : l_bc = (asDWORD *)221;
			goto case_FAULT;
			INSTRUCTION(222) : l_bc = (asDWORD *)222;
			goto case_FAULT;
			INSTRUCTION(223) : l_bc = (asDWORD *)223;
			goto case_FAULT;
			INSTRUCTION(224) : l_bc = (asDWORD *)224;
			goto case_FAULT;
			INSTRUCTION(225) : l_bc = (asDWORD *)225;
			goto case_FAULT;
			INSTRUCTION(226) : l_bc = (asDWORD *)226;
			goto case_FAULT;
			INSTRUCTION(227) : l_bc = (asDWORD *)227;
			goto case_FAULT;
			INSTRUCTION(228) : l_bc = (asDWORD *)228;
			goto case_FAULT;
			INSTRUCTION(229) : l_bc = (asDWORD *)229;
			goto case_FAULT;
			INSTRUCTION(230) : l_bc = (asDWORD *)230;
			goto case_FAULT;
			INSTRUCTION(231) : l_bc = (asDWORD *)231;
			goto case_FAULT;
			INSTRUCTION(232) : l_bc = (asDWORD *)232;
			goto case_FAULT;
			INSTRUCTION(233) : l_bc = (asDWORD *)233;
			goto case_FAULT;
			INSTRUCTION(234) : l_bc = (asDWORD *)234;
			goto case_FAULT;
			INSTRUCTION(235) : l_bc = (asDWORD *)235;
			goto case_FAULT;
			INSTRUCTION(236) : l_bc = (asDWORD *)236;
			goto case_FAULT;
			INSTRUCTION(237) : l_bc = (asDWORD *)237;
			goto case_FAULT;
			INSTRUCTION(238) : l_bc = (asDWORD *)238;
			goto case_FAULT;
			INSTRUCTION(239) : l_bc = (asDWORD *)239;
			goto case_FAULT;
			INSTRUCTION(240) : l_bc = (asDWORD *)240;
			goto case_FAULT;
			INSTRUCTION(241) : l_bc = (asDWORD *)241;
			goto case_FAULT;
			INSTRUCTION(242) : l_bc = (asDWORD *)242;
			goto case_FAULT;
			INSTRUCTION(243) : l_bc = (asDWORD *)243;
			goto case_FAULT;
			INSTRUCTION(244) : l_bc = (asDWORD *)244;
			goto case_FAULT;
			INSTRUCTION(245) : l_bc = (asDWORD *)245;
			goto case_FAULT;
			INSTRUCTION(246) : l_bc = (asDWORD *)246;
			goto case_FAULT;
			INSTRUCTION(247) : l_bc = (asDWORD *)247;
			goto case_FAULT;
			INSTRUCTION(248) : l_bc = (asDWORD *)248;
			goto case_FAULT;
			INSTRUCTION(249) : l_bc = (asDWORD *)249;
			goto case_FAULT;
			INSTRUCTION(250) : l_bc = (asDWORD *)250;
			goto case_FAULT;
			INSTRUCTION(251) : l_bc = (asDWORD *)251;
			goto case_FAULT;
			INSTRUCTION(252) : l_bc = (asDWORD *)252;
			goto case_FAULT;
			INSTRUCTION(253) : l_bc = (asDWORD *)253;
			goto case_FAULT;
			INSTRUCTION(254) : l_bc = (asDWORD *)254;
			goto case_FAULT;
			INSTRUCTION(255) : l_bc = (asDWORD *)255;
			goto case_FAULT;
#endif
